...
module "avm-baseline" {
  ...
  project_for_templates          = var.project_for_templates
  vended_baselines_project       = var.vended_baselines_project
  vended_applications_project    = var.vended_applications_project
  ssh_key                        = var.ssh_key
